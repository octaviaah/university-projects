...
<body>
<h1 class="main-title">Your logs</h1>
<?php
...
$total_pages_sql = "SELECT COUNT(*) FROM logbook WHERE user = '$userId'";

//total rows and pages for browse your logs
$res = $conn->query($total_pages_sql);
$total_rows = mysqli_fetch_array($res)[0];
$total_pages = ceil($total_rows / $no_of_records_per_page);

$query = "SELECT * FROM logbook WHERE user = '$userId' LIMIT " .$offset .', '. $no_of_records_per_page . ';';
